...
class DrawerCateringPage extends StatefulWidget {
  const DrawerCateringPage({super.key});

  @override
  State<DrawerCateringPage> createState() => _DrawerCateringPageState();
}

class _DrawerCateringPageState extends State<DrawerCateringPage> {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const HomeCateringPage(),
                          ),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const EditProfileCatering(),
                          ),
                        );
                      },
                      child: Container(
